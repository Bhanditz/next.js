...
export default class Router {
  constructor (url, { Component, ErrorComponent, ContainerComponent, ctx } = {}) {
  ...
  update (route, { Component, ContainerComponent = this.ContainerComponent }) {
    const data = this.components[route] || {}
    const newData = { ...data, ContainerComponent }
    if (Component) {
